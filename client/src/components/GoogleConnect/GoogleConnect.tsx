import { CssBaseline, Typography, Grid, Paper, Box, Link, Button } from '@material-ui/core';
      ...
      <Grid item xs={12} sm={7} md={5}>
        ...
        <Paper elevation={6} square>
          <Box className={classes.cardContainer}>
            <Box width="100%" p={3} alignSelf="center" justifyContent="center">
              ...
              <Typography className={classes.text}>
                {`The easiest way for you to ${rootPage} is with Google.`}
                <br /> This will automatically connect your calendar so you
                <br /> can start using CalendApp right away!
              </Typography>
            </Box>
            <Box m={1} alignSelf="center">
              <Button color="primary" className={classes.googleButton} href="http://localhost:3001/auth/google">
                <svg className={classes.googleLogo} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
